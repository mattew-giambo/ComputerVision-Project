...
- [Proposed Method](#proposed-method)
  ...
  - [FourierNet Branch](#fouriernet-branch)
  - [RGB and Depth Branches](#rgb-and-depth-branches)
  - [Hierarchical Multi-Stage Fusion (RGB-D and Fourier)](#hierarchical-multi-stage-fusion-rgb-d-and-fourier)
  - [Classification Heads](#classification-heads)
  - [Multi-Task Loss and weighting parameter Lambda](#multi-task-loss-and-weighting-parameter-lambda)
  - [Unimodal Baselines](#unimodal-baselines)
- [Experimental Setup](#experimental-setup)
- [Model Evaluation](#model-evaluation)
  - [Learning Curves — $\lambda$ = 0.5](#learning-curves-lambda-05)
  - [Confusion Matrices — $\lambda$ = 0.5](#confusion-matrices-lambda-05)
  - [ROC Curves and AUC — $\lambda$ = 0.5](#roc-curves-and-auc-lambda-05)
  ...
  - [Comprehensive Evaluation Summary Table](#comprehensive-evaluation-summary-table)
